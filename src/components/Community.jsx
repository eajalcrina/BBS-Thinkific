...
export default function Community() {
  ...
  return (
    <section id="comunidad" style={{ background:'var(--lime)', position:'relative', overflow:'hidden' }}>
              ...
              <div style={{ background:'var(--white)', borderRadius:20, padding:'2rem', boxShadow:'0 16px 48px rgba(14,14,14,0.12)' }}>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:'0.65rem' }}>
                  ...
                  <div style={{ display:'flex', gap:'0.5rem' }}>
                    <select value={dialCode} onChange={e=>setDialCode(e.target.value)} className="field" style={{ width:110, flexShrink:0, WebkitAppearance:'none' }}>{COUNTRY_CODES.map(c=>(<option key={c.code+c.name} value={c.code}>{c.flag} {c.code}</option>))}</select>
      ...
      <div style={{ position:'relative', marginTop:60, zIndex:1 }}>
