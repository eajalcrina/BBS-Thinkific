        ...
        <FadeIn delay={0.18}>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'2rem', alignItems:'start' }} className="comm-grid">
            <div style={{ display:'flex', flexDirection:'column', gap:'1rem' }}>
              <div style={{ background:'var(--white)', borderRadius:20, padding:'1.5rem', boxShadow:'0 8px 32px rgba(14,14,14,0.1)', border:'2px solid transparent', transition:'border-color 0.2s' }} onMouseEnter={e=>e.currentTarget.style.borderColor='var(--lime-d)'} onMouseLeave={e=>e.currentTarget.style.borderColor='transparent'}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'0.9rem' }}>
                  <div><div style={{ display:'flex', alignItems:'center', gap:'0.5rem', marginBottom:'0.3rem' }}><span style={{ fontFamily:'var(--fout)', fontSize:'1.2rem', fontWeight:600, color:'var(--dark)' }}>Starter</span><span className="badge badge-lime">Gratis</span></div><div style={{ fontSize:'0.8rem', color:'var(--t-dark2)', lineHeight:1.5 }}>Para profesionales que inician. Clínicas mensuales, Radar de fondos, BBS Library.</div></div>
                  <div style={{ textAlign:'right', flexShrink:0, marginLeft:'1rem' }}><div style={{ fontFamily:'var(--fbc)', fontSize:'2rem', fontWeight:800, color:'var(--dark)', lineHeight:1 }}>$0</div><div style={{ fontSize:'0.72rem', color:'var(--t-dark3)' }}>/mes</div></div>
                </div>
              </div>
              <div style={{ background:'var(--dark)', borderRadius:20, padding:'1.5rem', boxShadow:'0 8px 32px rgba(14,14,14,0.2)' }}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:'0.9rem' }}>
                  <div><div style={{ fontFamily:'var(--fout)', fontSize:'1.2rem', fontWeight:600, color:'var(--white)', marginBottom:'0.3rem' }}>PRO</div><div style={{ fontSize:'0.8rem', color:'var(--t-white2)', lineHeight:1.5 }}>4h/mes consultoría 1:1, Investment Matchmaking, Masterclasses avanzadas, podcast privado.</div></div>
                  <div style={{ textAlign:'right', flexShrink:0, marginLeft:'1rem' }}><div style={{ fontFamily:'var(--fbc)', fontSize:'2rem', fontWeight:800, color:'var(--lime)', lineHeight:1 }}>$87</div><div style={{ fontSize:'0.72rem', color:'var(--t-white3)' }}>/mes</div></div>
                </div>
              </div>
